...
import { FormConteinerProps } from "../../models/interfaces/FormContainerProps/FormContainerProps";
...
export const FormContainer = styled.div<FormConteinerProps>`
  display: flex;
  justify-content: center;
  align-items: center;
  gap: 0.8rem;
  ...
  & input {
    background: ${(props: FormConteinerProps) =>
      props.invalid ? "#e43f4d7a" : "transparent"};

    box-shadow: ${(props: FormConteinerProps) =>
